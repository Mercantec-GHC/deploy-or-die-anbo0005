...
<svg viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SSH">
  ...
  <text x="155" y="50" text-anchor="middle" fill="#5c6b7a" font-size="10">SSH nøgle</text>
...
<svg viewBox="0 0 320 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="VM">
  ...
  <text x="160" y="42" text-anchor="middle" fill="#5c6b7a" font-size="11">root SSH: NEJ</text>
  <text x="160" y="62" text-anchor="middle" fill="#5c6b7a" font-size="11">kun nøgle + UFW</text>
</svg>`,
...
<svg viewBox="0 0 340 110" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Tunnel">
  <text x="30" y="55" fill="#334155" font-size="11">Bruger</text>
...
<svg viewBox="0 0 320 130" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Image">
  ...
  <text x="160" y="58" text-anchor="middle" fill="#5c6b7a" font-size="10">docker run ↓</text>
...
<svg viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Container">
  ...
  <text x="160" y="45" text-anchor="middle" fill="#5c6b7a" font-size="10">VM</text>
...
<svg viewBox="0 0 320 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Volume">
  ...
  <text x="230" y="72" text-anchor="middle" fill="#5c6b7a" font-size="9">pgdata</text>
</svg>`,
...
<svg viewBox="0 0 340 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Nginx">
  ...
  <text x="60" y="55" fill="#5c6b7a" font-size="10">/ → app</text>
  <text x="250" y="50" fill="#5c6b7a" font-size="9">/api/→:5000</text>
</svg>`,
...
<svg viewBox="0 0 300 80" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="HTTPS">
  ...
  <text x="150" y="58" text-anchor="middle" fill="#5c6b7a" font-size="10">Cloudflare → tunnel → VM</text>
</svg>`,
...
<svg viewBox="0 0 280 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Dockerfile">
  ...
  <text x="80" y="40" text-anchor="middle" fill="#5c6b7a" font-size="9">FROM</text>
  <text x="80" y="55" text-anchor="middle" fill="#5c6b7a" font-size="9">COPY</text>
  <text x="80" y="70" text-anchor="middle" fill="#5c6b7a" font-size="9">CMD</text>
...
<svg viewBox="0 0 320 130" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Compose">
  ...
  <text x="160" y="55" text-anchor="middle" fill="#5c6b7a" font-size="9">compose net</text>
  <text x="160" y="105" text-anchor="middle" fill="#5c6b7a" font-size="10">docker-compose.yml</text>
</svg>`,

  cicd: `
<svg viewBox="0 0 340 90" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="CI/CD">
  <text x="40" y="50" fill="#334155" font-size="10">git push</text>
...
<svg viewBox="0 0 300 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Dokploy">
  ...
  <text x="150" y="65" text-anchor="middle" fill="#5c6b7a" font-size="9">webhook → deploy</text>
</svg>`,
...
<svg viewBox="0 0 300 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kubernetes">
  ...
  <text x="150" y="45" text-anchor="middle" fill="#2563eb" font-size="11">Kubernetes</text>
  <text x="150" y="62" text-anchor="middle" fill="#5c6b7a" font-size="9">pods + services</text>
</svg>`,
...
<svg viewBox="0 0 300 90" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Monitoring">
  ...
  <text x="150" y="78" text-anchor="middle" fill="#5c6b7a" font-size="10">status + logs + uptime</text>
</svg>`,
...
<svg viewBox="0 0 280 80" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="OWASP">
  ...
  <text x="140" y="58" text-anchor="middle" fill="#5c6b7a" font-size="10">Top 10 risici</text>
</svg>`,
...
<svg viewBox="0 0 300 90" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Headers">
  ...
  <text x="150" y="58" text-anchor="middle" fill="#5c6b7a" font-size="9">HTTP response headers</text>
</svg>`,
...
<svg viewBox="0 0 300 80" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="CTF">
  ...
  <text x="150" y="58" text-anchor="middle" fill="#5c6b7a" font-size="10">etisk test-app</text>
</svg>`,

  incident: `
<svg viewBox="0 0 320 70" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Incident">
  <text x="40" y="40" fill="#5c6b7a" font-size="8">Detect</text>
  <text x="95" y="40" fill="#5c6b7a" font-size="8">Contain</text>
  <text x="155" y="40" fill="#5c6b7a" font-size="8">Fix</text>
  <text x="210" y="40" fill="#5c6b7a" font-size="8">Recover</text>
  <text x="265" y="40" fill="#5c6b7a" font-size="8">Learn</text>
