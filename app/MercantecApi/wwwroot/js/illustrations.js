...
function lockerScene() {
  return scene("SSH", `
    ...
    <g filter="url(#soft)">
      <rect x="200" y="75" width="130" height="150" rx="10" fill="#e2e8f0" stroke="#64748b" stroke-width="2"/>
      <rect x="220" y="95" width="90" height="90" rx="6" fill="#94a3b8"/>
      <circle cx="265" cy="140" r="22" fill="#fbbf24" stroke="#d97706" stroke-width="3"/>
      <rect x="255" y="128" width="20" height="24" rx="4" fill="#fde68a" stroke="#d97706"/>
      <circle cx="265" cy="136" r="4" fill="#92400e"/>
      <text x="265" y="210" text-anchor="middle" font-size="11" fill="#334155" font-weight="700">VM-dør</text>
      <text x="265" y="225" text-anchor="middle" font-size="9" fill="#64748b">låst med nøgle</text>
    </g>
    <g filter="url(#soft)">
      <text x="400" y="130" font-size="36">🔑</text>
      <text x="400" y="160" font-size="10" fill="#854d0e">privat nøgle</text>
      <text x="400" y="175" font-size="9" fill="#64748b">kun på Mac</text>
    </g>
...
const ILLUSTRATIONS = {
  ...
  "vm-basics": scene("VM", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="360" y="175" text-anchor="middle" font-size="14" fill="#334155" font-weight="700">Hele huset = VM</text>
      <text x="360" y="198" text-anchor="middle" font-size="11" fill="#64748b">Ubuntu = operativsystemet inde i huset</text>
      <text x="360" y="218" text-anchor="middle" font-size="10" fill="#94a3b8">Containere = rum inde i huset (senere)</text>
    </g>
  `),
  ...
  "vm-hardening": scene("Hardening", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="145" text-anchor="middle" font-size="13" fill="#334155" font-weight="700">Færre åbne døre</text>
      <text x="360" y="168" text-anchor="middle" font-size="10" fill="#dc2626">❌ root · ❌ password-login</text>
      <text x="360" y="188" text-anchor="middle" font-size="10" fill="#16a34a">✅ SSH-nøgle · ✅ UFW</text>
      <text x="360" y="210" text-anchor="middle" font-size="9" fill="#64748b">Hardening = gør huset sværere at bryde ind i</text>
    </g>
  `),
  ...
  cloudflared: scene("cloudflared", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="250" y="200" text-anchor="middle" font-size="10" fill="#0369a1" font-weight="700">cloudflared</text>
    </g>
  ...
  ufw: scene("UFW", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="165" text-anchor="middle" font-size="13" fill="#b91c1c" font-weight="700">Portvagt UFW</text>
      <text x="360" y="188" text-anchor="middle" font-size="9" fill="#64748b">"Har du tilladelse?"</text>
    </g>
    <text x="90" y="120" font-size="11" fill="#16a34a">✅ 22 SSH</text>
    <text x="90" y="142" font-size="11" fill="#16a34a">✅ 80/443</text>
    ${arrow(175, 130, 255, 130)}
    <text x="520" y="120" font-size="11" fill="#dc2626">❌ 5432</text>
    <text x="520" y="142" font-size="11" fill="#dc2626">❌ 8080</text>
  ...
  "cloudflare-tunnel": scene("Tunnel", `
    ...
    <text x="380" y="115" text-anchor="middle" font-size="9" fill="#0369a1">sikker tunnel</text>
  ...
  "docker-container": scene("Container", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="420" y="145" text-anchor="middle" font-size="11" fill="#64748b">VM = hele huset</text>
      <text x="420" y="168" text-anchor="middle" font-size="11" fill="#64748b">Container = ét rum</text>
      <text x="420" y="191" text-anchor="middle" font-size="11" fill="#64748b">App = møbler i rummet</text>
    </g>
  `),
  ...
  "docker-image": scene("Image", `
    <g filter="url(#soft)">
      ...
      <text x="155" y="105" text-anchor="middle" font-size="12" fill="#b45309" font-weight="700">Opskrift</text>
      <text x="155" y="130" text-anchor="middle" font-size="9" fill="#78716c" font-family="monospace">FROM · COPY</text>
      <text x="155" y="165" text-anchor="middle" font-size="36">📋</text>
      <text x="155" y="210" text-anchor="middle" font-size="10" fill="#64748b">image (frossen)</text>
    </g>
  ...
  "postgres-volume": scene("Volume", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="350" y="160" text-anchor="middle" font-size="12" fill="#166534" font-weight="700">pgdata</text>
      <text x="350" y="180" text-anchor="middle" font-size="9" fill="#64748b">skab på væggen</text>
      <text x="350" y="200" text-anchor="middle" font-size="9" fill="#64748b">(udenfor kassen)</text>
    </g>
  ...
  nginx: scene("Nginx", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="280" y="165" text-anchor="middle" font-size="12" fill="#166534" font-weight="700">nginx</text>
      <text x="280" y="182" text-anchor="middle" font-size="9" fill="#64748b">portvagt / reception</text>
    </g>
    <text x="420" y="125" font-size="10" fill="#334155">/ → statisk fil</text>
    ${arrow(360, 140, 410, 125)}
    <text x="420" y="165" font-size="10" fill="#334155">/api/ → app :5000</text>
  ...
  "reverse-proxy": scene("Reverse proxy", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="270" y="168" text-anchor="middle" font-size="11" fill="#4338ca" font-weight="700">nginx videresender</text>
    </g>
    <text x="400" y="130" font-size="10" fill="#334155">/ → HTML</text>
    ${arrow(345, 135, 395, 128)}
    <text x="400" y="165" font-size="10" fill="#334155">/api/ → Kestrel</text>
  ...
  "github-actions": scene("CI", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="295" y="170" text-anchor="middle" font-size="11" fill="#334155" font-weight="700">GitHub Actions</text>
      <text x="295" y="188" text-anchor="middle" font-size="9" fill="#64748b">CI = kvalitetskontrol</text>
    </g>
  ...
  dokploy: scene("Dokploy", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="155" text-anchor="middle" font-size="14" fill="#4338ca" font-weight="700">Dokploy-panel</text>
      <rect x="300" y="170" width="120" height="36" rx="8" fill="#6366f1"/>
      <text x="360" y="193" text-anchor="middle" font-size="11" fill="#fff" font-weight="600">DEPLOY</text>
    </g>
  ...
  webhook: scene("Webhook", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="295" y="195" text-anchor="middle" font-size="9" fill="#854d0e">webhook URL</text>
    </g>
  ...
  "kubernetes-pod": scene("Kubernetes", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="100" text-anchor="middle" font-size="12" fill="#1d4ed8" font-weight="700">K8s cluster = børnehave for pods</text>
      ...
      <text x="360" y="210" text-anchor="middle" font-size="9" fill="#64748b">Vi bruger Compose + Dokploy i praksis</text>
    </g>
  `),
  ...
  "pg-dump": scene("Backup", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="340" y="175" text-anchor="middle" font-size="10" fill="#92400e" font-weight="700">backup.sql</text>
      <text x="340" y="192" text-anchor="middle" font-size="9" fill="#64748b">kopi udenfor volume</text>
    </g>
  ...
  monitoring: scene("Monitoring", `
    <g filter="url(#soft)">
      ...
      <text x="220" y="165" text-anchor="middle" font-size="12" fill="#166534" font-weight="700">Monitoring</text>
      <text x="220" y="185" text-anchor="middle" font-size="9" fill="#64748b">"Lever det?"</text>
    </g>
  ...
  logging: scene("Logging", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="160" text-anchor="middle" font-size="13" fill="#92400e" font-weight="700">App-dagbog</text>
      <text x="360" y="185" text-anchor="middle" font-size="10" fill="#64748b">stdout / stderr → Dokploy Logs</text>
      <text x="360" y="205" text-anchor="middle" font-size="9" fill="#dc2626">Log aldrig passwords!</text>
    </g>
  `),
  ...
  "uptime-kuma": scene("Uptime Kuma", `
    <g filter="url(#soft)">
      ...
      <text x="200" y="210" text-anchor="middle" font-size="10" fill="#166534" font-weight="700">Uptime Kuma</text>
    </g>
  ...
  "owasp-top10": scene("OWASP", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="120" text-anchor="middle" font-size="10" fill="#64748b">Opslagstavle over typiske web-fejl</text>
      ...
      <text x="360" y="190" text-anchor="middle" font-size="9" fill="#64748b">Access · Injection · Config · Outdated · Auth …</text>
  ...
  "security-headers": scene("Headers", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="150" text-anchor="middle" font-size="12" fill="#0f172a" font-weight="700">HTTP-svar med ekstra mærker</text>
      <text x="360" y="175" text-anchor="middle" font-size="10" fill="#16a34a">CSP · HSTS · X-Frame · X-Content-Type</text>
      <text x="360" y="195" text-anchor="middle" font-size="9" fill="#64748b">Browseren får regler med hvert svar</text>
    </g>
  `),
  ...
  "env-vs-secrets": scene("Secrets", `
    <g filter="url(#soft)">
      ...
      <text x="180" y="175" text-anchor="middle" font-size="11" fill="#166534" font-weight="700">.env / secrets</text>
      <text x="180" y="192" text-anchor="middle" font-size="9" fill="#64748b">passwords her ✅</text>
    </g>
    <g filter="url(#soft)">
      ...
      <text x="540" y="175" text-anchor="middle" font-size="11" fill="#b91c1c" font-weight="700">git repo</text>
      <text x="540" y="192" text-anchor="middle" font-size="9" fill="#64748b">aldrig secrets ❌</text>
    </g>
  ...
  trivy: scene("Trivy", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="350" y="210" text-anchor="middle" font-size="11" fill="#b91c1c" font-weight="700">Trivy</text>
    </g>
  ...
  "non-root-container": scene("Non-root", `
    <g filter="url(#soft)">
      ...
      <text x="270" y="175" text-anchor="middle" font-size="10" fill="#b91c1c">root ❌</text>
    </g>
    ...
    <g filter="url(#soft)">
      ...
      <text x="470" y="175" text-anchor="middle" font-size="10" fill="#166534">appuser ✅</text>
    </g>
  ...
  ctf: scene("CTF", `
    <g filter="url(#soft)">
      ...
      <text x="360" y="160" text-anchor="middle" font-size="14" fill="#b45309" font-weight="700">Skattejagt i test-app</text>
      <text x="360" y="185" text-anchor="middle" font-size="11" fill="#64748b">Find FLAG{...} · kun med tilladelse</text>
      <text x="360" y="210" text-anchor="middle" font-size="10" fill="#64748b">recon → test → exploit → lær</text>
    </g>
  `),
  ...
  "sql-injection": scene("SQL injection", `
    ...
    <g filter="url(#soft)">
      ...
      <text x="300" y="175" text-anchor="middle" font-size="10" fill="#b91c1c">SQL bliver gift</text>
    </g>
    ${arrow(380, 155, 435, 155)}
  ...
  "incident-response": scene("Incident", `
    ${["Detect", "Contain", "Fix", "Recover", "Learn"].map((s, i) => {
      ...
      return `<g filter="url(#soft)">
        ...
        <text x="${cx}" y="152" text-anchor="middle" font-size="8" fill="#334155" font-weight="600">${s}</text>
  ...
  "security-logs": scene("Security logs", `
    <g filter="url(#soft)">
      ...
      <text x="200" y="200" text-anchor="middle" font-size="10" fill="#1d4ed8" font-weight="700">Detektiv</text>
    </g>
    ${arrow(255, 135, 310, 135)}
    <g filter="url(#soft)">
      <rect x="315" y="85" width="200" height="120" rx="12" fill="#f8fafc" stroke="#64748b" stroke-width="2"/>
      <text x="415" y="125" text-anchor="middle" font-size="10" fill="#64748b" font-family="monospace">404 404 404 …</text>
      <text x="415" y="145" text-anchor="middle" font-size="10" fill="#dc2626" font-family="monospace">401 401 401 …</text>
      <text x="415" y="175" text-anchor="middle" font-size="10" fill="#334155">nginx + Dokploy logs</text>
    </g>
